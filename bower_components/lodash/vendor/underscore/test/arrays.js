(function () {
  ...
  QUnit.test('difference', function (assert) {
    ...
    result = (function () {
      return _.difference(arguments, [2, 30, 40]);
    }(1, 2, 3));
  ...
  QUnit.test('findIndex', function (assert) {
    ...
    var array = [1, 2, 3, 4];
    array.match = 55;
    assert.strictEqual(_.findIndex(array, function (x) {
      return x === 55;
  ...
  QUnit.test('findLastIndex', function (assert) {
    ...
    var array = [1, 2, 3, 4];
    array.match = 55;
    assert.strictEqual(_.findLastIndex(array, function (x) {
      return x === 55;
    }), -1, 'doesn\'t match array-likes keys');
  });
