;(function (window) {
  ...
  ui.buildPath = (function () {
    ...
    switch (build) {
      case 'lodash':
        ...
        break;
      case 'lodash-core-dev':
        result = 'dist/lodash.core.js';
        break;
      case 'lodash-core':
        result = 'dist/lodash.core.min.js';
        break;
      case null:
        build = 'lodash-dev';
      case 'lodash-dev':
  ...
  ui.loaderPath = (function () {
    ...
    switch (loader) {
      case 'curl':
        result = 'node_modules/curl-amd/dist/curl-kitchen-sink/curl.js';
        break;
      case 'dojo':
        result = 'node_modules/dojo/dojo.js';
        break;
      case 'requirejs':
        result = 'node_modules/requirejs/require.js';
        break;
      case null:
        loader = 'none';
        return '';
